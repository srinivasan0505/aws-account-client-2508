...
// Import Post_Delete_Alternate_ContactMCPTool - included in same package
// Import Post_Put_Contact_InformationMCPTool - included in same package
// Import Post_Enable_RegionMCPTool - included in same package
// Import Post_List_RegionsMCPTool - included in same package
// Import Post_Get_Alternate_ContactMCPTool - included in same package
// Import Post_Put_Alternate_ContactMCPTool - included in same package
// Import Post_Get_Region_Opt_StatusMCPTool - included in same package
// Import Post_Disable_RegionMCPTool - included in same package
// Import Post_Get_Contact_InformationMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Post_Delete_Alternate_ContactMCPTool.createPost_Delete_Alternate_ContactTool(config),
            Post_Put_Contact_InformationMCPTool.createPost_Put_Contact_InformationTool(config),
            Post_Enable_RegionMCPTool.createPost_Enable_RegionTool(config),
            Post_List_RegionsMCPTool.createPost_List_RegionsTool(config),
            Post_Get_Alternate_ContactMCPTool.createPost_Get_Alternate_ContactTool(config),
            Post_Put_Alternate_ContactMCPTool.createPost_Put_Alternate_ContactTool(config),
            Post_Get_Region_Opt_StatusMCPTool.createPost_Get_Region_Opt_StatusTool(config),
            Post_Disable_RegionMCPTool.createPost_Disable_RegionTool(config),
            Post_Get_Contact_InformationMCPTool.createPost_Get_Contact_InformationTool(config)
            );
