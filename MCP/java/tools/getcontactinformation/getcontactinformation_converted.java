...
class Post_Get_Contact_InformationMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Get_Contact_InformationHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("AccountId")) {
            queryParams.add("AccountId=" + args.get("AccountId"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_get_contact_information" + queryString;
    ...
    public static MCPServer.Tool createPost_Get_Contact_InformationTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_get_contact_information",
            "No description available",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Get_Contact_InformationHandler(config));
    }
