...
class Post_Get_Alternate_ContactMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Get_Alternate_ContactHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("AlternateContactType")) {
            queryParams.add("AlternateContactType=" + args.get("AlternateContactType"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_get_alternate_contact" + queryString;
    ...
    public static MCPServer.Tool createPost_Get_Alternate_ContactTool(MCPServer.APIConfig config) {
        ...
        AlternateContactTypeProperty.put("description", "Input parameter: Specifies which alternate contact you want to retrieve.");
        properties.put("AlternateContactType", AlternateContactTypeProperty);
        parameters.put("properties", properties);
        
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_get_alternate_contact",
            "No description available",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Get_Alternate_ContactHandler(config));
    }
