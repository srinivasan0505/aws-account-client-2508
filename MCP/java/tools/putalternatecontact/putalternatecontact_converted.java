...
class Post_Put_Alternate_ContactMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Put_Alternate_ContactHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("EmailAddress")) {
            queryParams.add("EmailAddress=" + args.get("EmailAddress"));
        }
        ...
        if (args.containsKey("Title")) {
            queryParams.add("Title=" + args.get("Title"));
        }
        ...
        if (args.containsKey("AlternateContactType")) {
            queryParams.add("AlternateContactType=" + args.get("AlternateContactType"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_put_alternate_contact" + queryString;
    ...
    public static MCPServer.Tool createPost_Put_Alternate_ContactTool(MCPServer.APIConfig config) {
        ...
        Map<String, Object> EmailAddressProperty = new HashMap<>();
        EmailAddressProperty.put("type", "string");
        EmailAddressProperty.put("required", true);
        EmailAddressProperty.put("description", "Input parameter: Specifies an email address for the alternate contact.");
        properties.put("EmailAddress", EmailAddressProperty);
        Map<String, Object> NameProperty = new HashMap<>();
        NameProperty.put("type", "string");
        NameProperty.put("required", true);
        NameProperty.put("description", "Input parameter: Specifies a name for the alternate contact.");
        properties.put("Name", NameProperty);
        Map<String, Object> PhoneNumberProperty = new HashMap<>();
        PhoneNumberProperty.put("type", "string");
        PhoneNumberProperty.put("required", true);
        PhoneNumberProperty.put("description", "Input parameter: Specifies a phone number for the alternate contact.");
        properties.put("PhoneNumber", PhoneNumberProperty);
        Map<String, Object> TitleProperty = new HashMap<>();
        TitleProperty.put("type", "string");
        TitleProperty.put("required", true);
        TitleProperty.put("description", "Input parameter: Specifies a title for the alternate contact.");
        ...
        AlternateContactTypeProperty.put("description", "Input parameter: Specifies which alternate contact you want to create or update.");
        properties.put("AlternateContactType", AlternateContactTypeProperty);
        parameters.put("properties", properties);
        
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_put_alternate_contact",
            "No description available",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Put_Alternate_ContactHandler(config));
    }
