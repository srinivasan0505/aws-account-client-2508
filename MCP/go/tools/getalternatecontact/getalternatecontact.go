...
func GetalternatecontactHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetAlternateContactrequest
		...
		url := fmt.Sprintf("%s/getAlternateContact", cfg.BaseURL)
		...
		var result models.GetAlternateContactResponse
...
func CreateGetalternatecontactTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_getAlternateContact",
		...
		mcp.WithString("AlternateContactType", mcp.Required(), mcp.Description("Input parameter: Specifies which alternate contact you want to retrieve.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetalternatecontactHandler(cfg),
	}
}
