...
func DisableregionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DisableRegionrequest
		...
		url := fmt.Sprintf("%s/disableRegion", cfg.BaseURL)
...
func CreateDisableregionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_disableRegion",
		mcp.WithDescription("Disables (opts-out) a particular Region for an account."),
