...
func DeletealternatecontactHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteAlternateContactrequest
		...
		url := fmt.Sprintf("%s/deleteAlternateContact", cfg.BaseURL)
...
func CreateDeletealternatecontactTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_deleteAlternateContact",
		...
		mcp.WithString("AlternateContactType", mcp.Required(), mcp.Description("Input parameter: Specifies which of the alternate contacts to delete. ")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeletealternatecontactHandler(cfg),
	}
}
