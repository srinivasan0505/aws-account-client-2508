...
func ListregionsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListRegionsrequest
		...
		url := fmt.Sprintf("%s/listRegions%s", cfg.BaseURL, queryString)
		...
		var result models.ListRegionsResponse
...
func CreateListregionsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_listRegions",
		mcp.WithDescription("Lists all the Regions for a given account and their respective opt-in statuses. Optionally, this list can be filtered by the <code>region-opt-status-contains</code> parameter. "),
