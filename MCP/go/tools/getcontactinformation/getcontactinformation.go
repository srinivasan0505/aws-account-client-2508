...
func GetcontactinformationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetContactInformationrequest
		...
		url := fmt.Sprintf("%s/getContactInformation", cfg.BaseURL)
		...
		var result models.GetContactInformationResponse
...
func CreateGetcontactinformationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_getContactInformation",
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetcontactinformationHandler(cfg),
	}
}
