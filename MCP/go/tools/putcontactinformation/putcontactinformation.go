...
func PutcontactinformationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PutContactInformationrequest
		...
		url := fmt.Sprintf("%s/putContactInformation", cfg.BaseURL)
...
func CreatePutcontactinformationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_putContactInformation",
		mcp.WithDescription("<p>Updates the primary contact information of an Amazon Web Services account.</p> <p>For complete details about how to use the primary contact operations, see <a href="https://docs.aws.amazon.com/accounts/latest/reference/manage-acct-update-contact.html">Update the primary and alternate contact information</a>.</p>"),
		...
		mcp.WithObject("ContactInformation", mcp.Required(), mcp.Description("Input parameter: Contains the details of the primary contact information associated with an Amazon Web Services account.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    PutcontactinformationHandler(cfg),
	}
}
