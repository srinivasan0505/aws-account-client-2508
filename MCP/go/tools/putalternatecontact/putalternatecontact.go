...
func PutalternatecontactHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PutAlternateContactrequest
		...
		url := fmt.Sprintf("%s/putAlternateContact", cfg.BaseURL)
...
func CreatePutalternatecontactTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_putAlternateContact",
		...
		mcp.WithString("EmailAddress", mcp.Required(), mcp.Description("Input parameter: Specifies an email address for the alternate contact. ")),
		mcp.WithString("Name", mcp.Required(), mcp.Description("Input parameter: Specifies a name for the alternate contact.")),
		mcp.WithString("PhoneNumber", mcp.Required(), mcp.Description("Input parameter: Specifies a phone number for the alternate contact.")),
		mcp.WithString("Title", mcp.Required(), mcp.Description("Input parameter: Specifies a title for the alternate contact.")),
		...
		mcp.WithString("AlternateContactType", mcp.Required(), mcp.Description("Input parameter: Specifies which alternate contact you want to create or update.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    PutalternatecontactHandler(cfg),
	}
}
