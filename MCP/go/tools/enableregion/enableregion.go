...
func EnableregionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.EnableRegionrequest
		...
		url := fmt.Sprintf("%s/enableRegion", cfg.BaseURL)
...
func CreateEnableregionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_enableRegion",
		mcp.WithDescription("Enables (opts-in) a particular Region for an account."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    EnableregionHandler(cfg),
	}
}
