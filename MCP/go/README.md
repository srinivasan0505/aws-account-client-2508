# AWS Account MCP Server

This MCP (Model Content Protocol) server provides access to AWS Account API functionality through HTTP, HTTPS, and STDIO transport modes.
